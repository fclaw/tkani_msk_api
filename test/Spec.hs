...
main = do
    ...
    -- Boundary: The 3% start (1000 RUB = 100,000 kopeks)
    -- Math: (100,000 * 3) / 10,000 = 30 points
    assertBonus "Amount 1,000.00 (3%)" 100000 0 0 30

    -- Boundary: The 5% start (5,000 RUB = 500,000 kopeks)
    -- Math: (500,000 * 5) / 10,000 = 250 points
    assertBonus "Amount 5,000.00 (5%)" 500000 0 0 250

    -- Boundary: The 7% VIP start (15,000 RUB = 1,500,000 kopeks)
    -- Math: (1,500,000 * 7) / 10,000 = 1,050 points
    assertBonus "Amount 15,000.00 (7%)" 1500000 0 0 1050

    -- Real World: Median Sale (26,500 RUB = 2,650,000 kopeks)
    -- Math: (2,650,000 * 7) / 10,000 = 1,855 points
    assertBonus "Median Sale 26.5k (7%)" 2650000 0 0 1855

    -- Real World: The Whale (108,000 RUB = 10,800,000 kopeks)
    -- Math: (10,800,000 * 7) / 10,000 = 7,560 points
    assertBonus "Whale Sale 108k (7%)" 10800000 0 0 7560

    -- Complexity Check: 30,000 RUB buy (3,000,000 kopeks), using 10,000 points.
    -- Cash: 3,000,000 - (10,000 * 100) = 2,000,000 kopeks.
    -- Rate: 7% (determined by total order size 3,000,000).
    -- Added Points: (2,000,000 * 7) / 10,000 = 1,400 points.
    -- Balance: 10,000 (bal) - 10,000 (used) + 1,400 (earned) = 1,400.
    assertBonus "Mixed Pay: 30k buy, 10k use" 3000000 10000 10000 1400
