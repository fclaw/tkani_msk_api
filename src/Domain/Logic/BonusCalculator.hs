...
calculate amountKopeks currentBalanceRub requestedToSpendRub =
    let
        ...
        -- but simpler: Max RUB spend is (Amount_in_kopeks / 100) / 2
        maxPointsPossible = fromIntegral $ (amountKopeks `div` 100) `div` 2
        ...
        rate | amountKopeks < 50000       = 0 -- 0% for < 500 RUB
             ...
             | amountKopeks >= 100000 && 
               amountKopeks < 500000      = 3 -- 3% for 1,000 - 4,999 RUB
             | amountKopeks >= 500000 && 
               amountKopeks < 1500000     = 5 -- 5% for 5,000 - 14,999 RUB
             | otherwise                  = 7 -- 7% for 15,000 RUB and above
