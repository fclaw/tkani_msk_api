-- Deploy tkani-api:00040.order to pg

BEGIN;

-- XXX Add DDLs here.
ALTER TYPE order_status ADD VALUE 'scheduled_for_pickup';
    ...
    */
    IF TG_OP = 'UPDATE' THEN
        ...
        IF 
            ...
            -- 3. --- THIS IS THE FIX ---
            --    Explicitly EXCLUDE the 'scheduled_for_pickup' status.
            --    This guarantees that moving an order to the next step in the
            --    shipping process will NOT trigger a weight subtraction.
            NEW.status <> 'scheduled_for_pickup'
